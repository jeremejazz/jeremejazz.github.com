...
Some staticgen offers simple configurtion that allows the user to change the title and theme to creating blogs contents though file organization. There are lots of applications that provides this. staticgen.com provides a good list and summary of these.
